...
#ifndef MAIN_MENUE_BORDGAME_ULTIMATETICTACTOE_H
#define MAIN_MENUE_BORDGAME_ULTIMATETICTACTOE_H
...
template<typename T>
class ultimatecomputerPlayer : public RandomPlayer<T> {
public:
    ultimatecomputerPlayer(T symbol) : RandomPlayer<T>(symbol) {
...
#endif //MAIN_MENUE_BORDGAME_ULTIMATETICTACTOE_H
