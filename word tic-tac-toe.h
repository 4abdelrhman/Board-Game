...
#ifndef MAIN_MENUE_BORDGAME_WORD_TIC_TAC_TOE_H
#define MAIN_MENUE_BORDGAME_WORD_TIC_TAC_TOE_H
...
template <typename T>
class wordHumanPlayer : public Player<T> {
public:
    wordHumanPlayer(string n, T symbol) : Player<T>(n, symbol) {}
...
#endif //MAIN_MENUE_BORDGAME_WORD_TIC_TAC_TOE_H
